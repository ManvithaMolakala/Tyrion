...
from extract_apy import find_best_investments  # Import the async function
...
top_investments = asyncio.run(find_best_investments(wallet_balance))
...
response = investment_agent.invoke(context)

# Print the AI's investment strategy suggestion
