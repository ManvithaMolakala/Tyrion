import os
import asyncio
from extract_apy import vesu_investment_options, strkfarm_investment_options  # Import the async function
import json
...
async def fetch_and_save_data():
    ...
    return vesu_json, strkfarm_json
...
def combine_and_save(vesu_json, strkfarm_json):
    """Combines the two investment data sets and saves the result"""
    combined_data = vesu_json + strkfarm_json
...
async def main():
    ...
    if choice == "yes":
        ...
        vesu_json, strkfarm_json = await fetch_and_save_data()

    combine_and_save(vesu_json, strkfarm_json)
